                        ...
                        <div class="services-details__left">
                            <div class="services-details__category">
                                ...
                                <ul class="services-details__category-list list-unstyled">
                                    ...
                                    <li class="active"><a href="#">Upload Finanacial documents<span class="icon-right-arrow"></span></a>
                                    </li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="contact-page__input-box">
                                                <label for="name">ITR Filling</label>
                                                ...
                                                <small>Upload minimum last 3 years ITR. Do not upload images. Only PDFs are accepted</small>
                                                <ul id="fileList"></ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="contact-page__input-box">
                                                <label for="name">Bank Statements</label>
                                                <div id="dropArea" ondragover="handleDragOver(event)" ondragleave="handleDragLeave(event)" ondrop="handleDrop(event)">
                                                    <p>Drag and drop files here, or click to select files.</p>
                                                    <input type="file" id="fileInput" multiple>
                                                </div>
                                                <small>Upload minimum last 3 years bank statement. Upload current account bank statement only. Do not upload images. Only PDFs are accepted</small>
                                                <ul id="fileList"></ul>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="contact-page__input-box">
                                                <label for="name">Balance Sheet*</label>
                                                <div id="dropArea" ondragover="handleDragOver(event)" ondragleave="handleDragLeave(event)" ondrop="handleDrop(event)">
                                                    <p>Drag and drop files here, or click to select files.</p>
                                                    <input type="file" id="fileInput" multiple>
                                                </div>
                                                <small>Upload minimum last 2 years P&L statement. Do not upload images. Only PDFs are accepted</small>
                                                <ul id="fileList"></ul>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="contact-page__input-box">
                                                <label for="name">POS transactions</label>
                                                <div id="dropArea" ondragover="handleDragOver(event)" ondragleave="handleDragLeave(event)" ondrop="handleDrop(event)">
                                                    <p>Drag and drop files here, or click to select files.</p>
                                                    <input type="file" id="fileInput" multiple>
                                                </div>
                                                <small>Upload minimum last 6 month transactions. Do not upload images. Only PDFs are accepted</small>
                                                <ul id="fileList"></ul>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="contact-page__input-box">
                                                <label for="name">Lease agreement*</label>
                                                <div id="dropArea" ondragover="handleDragOver(event)" ondragleave="handleDragLeave(event)" ondrop="handleDrop(event)">
                                                    <p>Drag and drop files here, or click to select files.</p>
                                                    <input type="file" id="fileInput" multiple>
                                                </div>
                                                <small>Upload active lease agreement . Do not upload images. Only PDFs are accepted</small>
                                                <ul id="fileList"></ul>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="contact-page__input-box">
                                                <label for="name">Proof of registration*</label>
                                                <div id="dropArea" ondragover="handleDragOver(event)" ondragleave="handleDragLeave(event)" ondrop="handleDrop(event)">
                                                    <p>Drag and drop files here, or click to select files.</p>
                                                    <input type="file" id="fileInput" multiple>
                                                </div>
                                                <small>Do not upload images. Only PDFs are accepted</small>
                                                <ul id="fileList"></ul>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="contact-page__btn-box">
                                                <button type="submit" class="thm-btn contact-page__btn float-end">Submit</button>
                                            </div>
                                        </div>
                                    </div>
