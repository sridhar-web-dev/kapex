                        ...
                        <div class="services-details__left">
                            <div class="services-details__category">
                                ...
                                <ul class="services-details__category-list list-unstyled">
                                    ...
                                    <li class="active"><a href="#">Our Decision<span class="icon-right-arrow"></span></a>
                                    </li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="contact-page__input-box">
                                               <h4>Your loan request : <strong>10,00,000</strong></h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="contact-page__input-box text-end">
                                               <h4>Store Name : <strong>Allen Solly</strong></h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 my-5">
                                         <div class="text-center my-5">
                                            <img src="<?php echo ABS_URL ?>assets/images/meter.png" class="img-fluid" alt="">
                                         <h2 class="my-3">Good chance of approval</h2>
                                            <h5>Kapex operations team is reviewing your application and we will inform our decision through SMS and Email within 24 business hours </h5>
                                         </div>
                                         <h4>Please note that the final approval is subject to </h4>
                                         <ul>
                                            <li>1, Successfully validating the documents submitted</li>
                                            <li>2, Verifying the store and landlord details</li>
                                            <li>3, Applicants KYC and  credit checks</li>
                                            <li>4, Auto debit setup.</li>
                                         </ul>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="contact-page__btn-box text-center">
                                                <button type="submit" class="thm-btn contact-page__btn">Logout</button>
                                            </div>
                                        </div>
                                    </div>
